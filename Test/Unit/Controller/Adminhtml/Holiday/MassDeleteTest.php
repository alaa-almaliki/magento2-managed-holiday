...
use Alaa\ManagedHoliday\Controller\Adminhtml\Holiday\MassDelete;
...
class MassDeleteTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->holidayRepository = $this->getMock(HolidayRepository::class, ['delete']);
        ...
        $this->subject = $this->getMock(MassDelete::class, ['getRequest'], $subjectConstructorArguments);
